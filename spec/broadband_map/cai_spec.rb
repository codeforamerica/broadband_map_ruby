...
describe BroadbandMap::Client::Cai do
  ...
  describe ".cai_closest" do
    before do
      sub_get("cai/closest?latitude=41.486857&longitude=-71.294392&maxresults=2&format=json&callback=").
    ...
    it "should return the correct item" do
      ...
      a_call("cai/closest?latitude=41.486857&longitude=-71.294392&maxresults=2&format=json&callback=").should have_been_made
